...
exports.isError = exports.enhance = exports.IGNORED_USERS = void 0;
/**
...
function isError(event) {
    var _a, _b;
    return ((_a = event.properties) === null || _a === void 0 ? void 0 : _a.error) || ((_b = event.properties) === null || _b === void 0 ? void 0 : _b.errors);
}
